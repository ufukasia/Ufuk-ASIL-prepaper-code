...
def main():
    ...
    parser.add_argument("--alpha_v_step", type=float, default=0.5, help="alpha_v adım değeri")
    parser.add_argument("--alpha_v_active", action="store_false", help="alpha_v parametresi için komut üret")
    
    # Beta_p parametreleri
    parser.add_argument("--beta_p_start", type=float, default=0.1, help="beta_p başlangıç değeri")
    parser.add_argument("--beta_p_end", type=float, default=20, help="beta_p bitiş değeri")
    parser.add_argument("--beta_p_step", type=float, default=0.5, help="beta_p adım değeri")
    parser.add_argument("--beta_p_active", action="store_false", help="beta_p parametresi için komut üret")
    ...
    parser.add_argument("--epsilon_v_step", type=float, default=0.5, help="epsilon_v adım değeri")
    ...
    parser.add_argument("--epsilon_p_start", type=float, default=0.1, help="epsilon_p başlangıç değeri")
    parser.add_argument("--epsilon_p_end", type=float, default=20, help="epsilon_p bitiş değeri")
    parser.add_argument("--epsilon_p_step", type=float, default=0.5, help="epsilon_p adım değeri")
    parser.add_argument("--epsilon_p_active", action="store_false", help="epsilon_p parametresi için komut üret")
    ...
    parser.add_argument("--zeta_H_step", type=float, default=0.5, help="zeta_H adım değeri")
    ...
    parser.add_argument("--zeta_L_step", type=float, default=0.5, help="zeta_L adım değeri")
    parser.add_argument("--zeta_L_active", action="store_false", help="zeta_L parametresi için komut üret")
    
    # Zeta_p parametreleri
    parser.add_argument("--zeta_p_start", type=float, default=0.1, help="zeta_p başlangıç değeri")
    parser.add_argument("--zeta_p_end", type=float, default=20, help="zeta_p bitiş değeri")
    parser.add_argument("--zeta_p_step", type=float, default=0.5, help="zeta_p adım değeri")
    parser.add_argument("--zeta_p_active", action="store_false", help="zeta_p parametresi için komut üret")
    ...
    parser.add_argument("--entropy_norm_min_start", type=float, default=0.0, help="entropy_norm_min başlangıç değeri")
    parser.add_argument("--entropy_norm_min_end", type=float, default=0.0, help="entropy_norm_min bitiş değeri")
    parser.add_argument("--entropy_norm_min_step", type=float, default=0.0, help="entropy_norm_min adım değeri (0 ise tek değer)")
    parser.add_argument("--entropy_norm_min_active", action="store_true", help="entropy_norm_min parametresi için komut üret")
    
    # pose_chi2_norm_min parametreleri
    parser.add_argument("--pose_chi2_norm_min_start", type=float, default=1.0, help="pose_chi2_norm_min başlangıç değeri")
    parser.add_argument("--pose_chi2_norm_min_end", type=float, default=1.0, help="pose_chi2_norm_min bitiş değeri")
    parser.add_argument("--pose_chi2_norm_min_step", type=float, default=0.0, help="pose_chi2_norm_min adım değeri (0 ise tek değer)")
    parser.add_argument("--pose_chi2_norm_min_active", action="store_true", help="pose_chi2_norm_min parametresi için komut üret")
    
    # culled_norm_min parametreleri
    parser.add_argument("--culled_norm_min_start", type=float, default=0.0, help="culled_norm_min başlangıç değeri")
    parser.add_argument("--culled_norm_min_end", type=float, default=0.0, help="culled_norm_min bitiş değeri")
    parser.add_argument("--culled_norm_min_step", type=float, default=0.0, help="culled_norm_min adım değeri (0 ise tek değer)")
    parser.add_argument("--culled_norm_min_active", action="store_true", help="culled_norm_min parametresi için komut üret")
    ...
    if args.entropy_norm_min_active:
        for val in make_range(args.entropy_norm_min_start, args.entropy_norm_min_end, args.entropy_norm_min_step):
            commands.append(f'python "main_eskf.py" --entropy_norm_min {val:.3f}')
    if args.pose_chi2_norm_min_active:
        for val in make_range(args.pose_chi2_norm_min_start, args.pose_chi2_norm_min_end, args.pose_chi2_norm_min_step):
            commands.append(f'python "main_eskf.py" --pose_chi2_norm_min {val:.3f}')
    if args.culled_norm_min_active:
        for val in make_range(args.culled_norm_min_start, args.culled_norm_min_end, args.culled_norm_min_step):
            commands.append(f'python "main_eskf.py" --culled_norm_min {val:.3f}')
